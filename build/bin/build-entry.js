...
const EXPORT_TEMPLATE = 'export * from \'./components/{{package}}/index.js\';';
...
const exportsComponentTemplate = [];
...
componentNames.forEach(name => {
	...
	exportsComponentTemplate.push(render(EXPORT_TEMPLATE, {
		name: componentName,
		package: name,
	}));
...
const template = render(MAIN_TEMPLATE, {
	exports: exportsComponentTemplate.join(endOfLine),
